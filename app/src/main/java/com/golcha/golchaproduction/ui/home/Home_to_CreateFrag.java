...
public class Home_to_CreateFrag extends Fragment {
    ...
    AutoCompleteTextView autocomp_textView;
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                           ...
                           || pro_quantity_edittxt.getText().toString().isEmpty())
                        {
                            ...
                            new CallserviceGetResult_ofCreate().execute();
                        }
                    }
                }
        );
    ...
    class CallserviceGetResult_ofCreate extends AsyncTask<String, Void, String> {
        @Override
        protected void onPreExecute() {
            progressDialog.show();
            super.onPreExecute();
